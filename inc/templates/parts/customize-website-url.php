<script type="text/template" id="customize-justwpforms-website-url-template">
	...
	<p class="justwpforms-placeholder-option" style="display: <%= ( 'as_placeholder' !== instance.label_placement ) ? 'block' : 'none' %>">
		...
		<input type="text" id="<%= instance.id %>_placeholder" class="widefat title"- instance.placeholder %>" data-bind="placeholder" />
	</p>
	<p class="justwpforms-default-value-option">
		<label for="<%= instance.id %>_default_value"><?php _e( 'Prefill', 'justwpforms' ); ?></label>
		<input type="url" id="<%= instance.id %>_default_value" class="widefat title default_value" value="<%- instance.default_value %>" data-bind="default_value" />
	</p>
	<p>
	...
	<?php do_action( 'justwpforms_part_customize_website_url_before_options' ); ?>

	<?php do_action( 'justwpforms_part_customize_website_url_after_options' ); ?>

	<?php do_action( 'justwpforms_part_customize_website_url_before_advanced_options' ); ?>
	...
	<?php do_action( 'justwpforms_part_customize_website_url_after_advanced_options' ); ?>
