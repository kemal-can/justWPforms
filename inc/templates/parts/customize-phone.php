<script type="text/template" id="justwpforms-customize-phone-template">
	...
	<?php do_action( 'justwpforms_part_customize_phone_before_options' ); ?>

	<?php do_action( 'justwpforms_part_customize_phone_after_options' ); ?>

	<?php do_action( 'justwpforms_part_customize_phone_before_advanced_options' ); ?>

	<p>
		<label for="<%= instance.id %>_phone-format"><?php _e( 'Phone number format', 'justwpforms' ); ?></label>
		<span class="justwpforms-buttongroup">
			<label for="<%= instance.id %>-local">
				...
				<span><?php _e( 'Local', 'justwpforms' ); ?></span>
			</label>
			<label for="<%= instance.id %>-international">
				...
				<span><?php _e( 'International', 'justwpforms' ); ?></span>
			</label>
		</span>
		</p>
	<p>
	...
	<?php do_action( 'justwpforms_part_customize_phone_after_advanced_options' ); ?>
