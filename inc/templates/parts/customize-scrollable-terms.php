<script type="text/template" id="justwpforms-customize-scrollable-terms-template">
	...
	<?php do_action( 'justwpforms_part_customize_scrollable_terms_before_options' ); ?>

	<p>	
		<label for="<%= instance.id %>_terms_text"><?php _e( 'Text', 'justwpforms' ); ?></label>
	...
	<p>
		<label>
			<input type="checkbox" class="checkbox" value="1" <% if ( instance.required ) { %>checked="checked"<% } %> data-bind="required" /> <?php _e( 'Require full scroll', 'justwpforms' ); ?>
		</label>
	</p>

	<?php do_action( 'justwpforms_part_customize_scrollable_terms_after_options' ); ?>

	<?php do_action( 'justwpforms_part_customize_scrollable_terms_before_advanced_options' ); ?>

	<?php justwpforms_customize_part_width_control(); ?>

	<?php do_action( 'justwpforms_part_customize_scrollable_terms_after_advanced_options' ); ?>
