<script type="text/template" id="justwpforms-customize-rating-template">
	...
	<?php do_action( 'justwpforms_part_customize_rating_before_options' ); ?>

	<?php do_action( 'justwpforms_part_customize_rating_after_options' ); ?>

	<?php do_action( 'justwpforms_part_customize_rating_before_advanced_options' ); ?>
	...
	<?php do_action( 'justwpforms_part_customize_rating_after_advanced_options' ); ?>
