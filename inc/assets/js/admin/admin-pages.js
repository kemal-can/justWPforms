( function( $, settings ) {
	...
	$( document ).on( 'submit', '#justwpforms-settings-screen form.hf-ajax-submit', function( e ) {
		e.preventDefault();

		var $form    = $( e.target );
		var $wrapper = $form.parent();
		var $notices = $( '.justwpforms-settings-notices', $wrapper );
		...
		$.post( ajaxurl, $form.serialize(), function( response ) {
			...
			if ( $form.hasClass( 'justwpforms-updater-credentials' ) ) {
...
} ) ( jQuery, _justwpformsAdminPagesConfig );
