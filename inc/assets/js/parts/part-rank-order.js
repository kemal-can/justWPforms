( function( $, _, Backbone, api, settings ) {
	...
	justwpforms.classes.models.parts.rank_order = justwpforms.classes.models.Part.extend( {
		defaults: function() {
			return _.extend(
				{},
	...
	justwpforms.classes.views.parts.rank_orderOption = Backbone.View.extend( {
		template: '#customize-justwpforms-rank-order-item-template',
	...
	justwpforms.classes.views.parts.rank_order = justwpforms.classes.views.Part.extend( {
		template: '#customize-justwpforms-rank-order-template',
		...
		addOptionView: function( optionModel, options ) {
			var optionView = new justwpforms.classes.views.parts.rank_orderOption( _.extend( {
				model: optionModel,
				part: this.model,
			}, options ) );
