( function( $ ) {
	...
	justwpforms.parts.scale = {
		...
		updateTrackerColor: function() {
			...
			this.$input.css( {
				'background': 'linear-gradient(to right, var(--justwpforms-color-part-value) ' + percentValue + '%, var(--justwpforms-color-part-border) ' + percentValue + '%, var(--justwpforms-color-part-border) 100%)'
			} );
		}
	};
} )( jQuery );
