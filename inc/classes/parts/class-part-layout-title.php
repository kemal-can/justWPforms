...
class justwpforms_Part_LayoutTitle extends justwpforms_Form_Part {

	public $type = 'layout_title';

	public function __construct() {
		$this->label = __( 'Heading', 'justwpforms' );
		$this->description = __( 'For adding titles to visually separate fields.', 'justwpforms' );
	...
	public function customize_templates() {
		$template_path = justwpforms_get_include_folder() . '/templates/parts/customize-layout_title.php';
	...
	public function frontend_template( $part_data = array(), $form_data = array() ) {
		...
		include( justwpforms_get_include_folder() . '/templates/parts/frontend-layout_title.php' );
	}
	...
	public function customize_enqueue_scripts( $deps = array() ) {
		wp_enqueue_script(
			'part-layout_title',
			justwpforms_get_plugin_url() . 'inc/assets/js/parts/part-layout_title.js',
