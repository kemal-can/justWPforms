...
class justwpforms_Part_Media extends justwpforms_Form_Part {

	public $type = 'media';

	public function __construct() {
		$this->label = __( 'Media', 'justwpforms' );
		$this->description = __( 'For adding a single image, video, animated gif or audio clip.', 'justwpforms' );
	...
	public function customize_templates() {
		$template_path = justwpforms_get_include_folder() . '/templates/parts/customize-media.php';
	...
	public function frontend_template( $part_data = array(), $form_data = array() ) {
		...
		include( justwpforms_get_include_folder() . '/templates/parts/frontend-media.php' );
	}
	...
	public function customize_enqueue_scripts( $deps = array() ) {
		...
		wp_enqueue_script(
			'part-media',
			justwpforms_get_plugin_url() . 'inc/assets/js/parts/part-media.js',
