...
if ( ! function_exists( 'justwpforms_get_session' ) ):
/**
 * Get the justwpforms_Session class instance.
 *
 * @since 1.0
 *
 * @return justwpforms_Session
 */
function justwpforms_get_session() {
	return justwpforms_Session::instance();
}
