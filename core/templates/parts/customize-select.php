<script type="text/template" id="customize-justwpforms-select-template">
	...
	<?php do_action( 'justwpforms_part_customize_select_before_options' ); ?>
	...
	<?php do_action( 'justwpforms_part_customize_select_after_options' ); ?>

	<?php do_action( 'justwpforms_part_customize_select_before_advanced_options' ); ?>
	...
	<?php do_action( 'justwpforms_part_customize_select_after_advanced_options' ); ?>
...
<script type="text/template" id="customize-justwpforms-select-item-template">
...
<script type="text/template" id="customize-justwpforms-select-item-heading-template">
