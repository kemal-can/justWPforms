<script type="text/template" id="customize-justwpforms-email-template">
	...
	<?php do_action( 'justwpforms_part_customize_email_before_options' ); ?>

	<?php do_action( 'justwpforms_part_customize_email_after_options' ); ?>

	<?php do_action( 'justwpforms_part_customize_email_before_advanced_options' ); ?>
	...
	<?php do_action( 'justwpforms_part_customize_email_after_advanced_options' ); ?>
