<script type="text/template" id="customize-justwpforms-radio-template">
	...
	<?php do_action( 'justwpforms_part_customize_radio_before_options' ); ?>
...
Click the "Add Choice" button to start.', 'justwpforms' ); ?></p>
	</div>
	...
	<p class="links mode-import">
		<a href="#" class="button add-import-options" disabled><?php _e( 'Add choices', 'justwpforms' ); ?></a>
		<a href="#" class="button cancel-import-options"><?php _e( 'Cancel', 'justwpforms' ); ?></a>
	</p>

	<?php do_action( 'justwpforms_part_customize_radio_after_options' ); ?>

	<?php do_action( 'justwpforms_part_customize_radio_before_advanced_options' ); ?>
	...
	<?php do_action( 'justwpforms_part_customize_radio_after_advanced_options' ); ?>
...
<script type="text/template" id="customize-justwpforms-radio-item-template">
...
<script type="text/template" id="customize-justwpforms-radio-item-heading-template">
