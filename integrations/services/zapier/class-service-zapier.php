...
class justwpforms_Service_Zapier extends justwpforms_Service {

	public $id = 'zapier';
	public $group = 'automation';
	public $api_key_header = 'HTTP_X_HF_ZAPIER_API_KEY';

	public function __construct() {
		$this->label = __( 'Zapier', 'justwpforms' );
	}
	...
	public function admin_widget( $previous_credentials = array() ) {
		require_once( justwpforms_get_integrations_folder() . '/services/zapier/partial-widget.php' );
	}
	...
	public function load() {
		if ( $this->is_connected() ) {
			require_once( justwpforms_get_integrations_folder() . '/services/zapier/class-integration-zapier.php' );
		}
	}
	...
	public function get_activity_entry( $activity, $form ) {
		$parts = array_filter( $form['parts'], 'justwpforms_zapier_part_visible' );
		...
		foreach( $parts as $part_id => $part_value ) {
			...
			$parts[$part_id] = justwpforms_zapier_get_part_value( $part_value, $part, $form, $activity );
		}
		...
		$activity = apply_filters( 'justwpforms_zapier_activity_entry', $activity );
	...
	public function get_output_fields() {
		...
		$fields = apply_filters( 'justwpforms_zapier_output_fields', $fields );
