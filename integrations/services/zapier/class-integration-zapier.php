...
class justwpforms_Integration_Zapier {

	private static $instance;
	private static $hooked = false;
	private $service;

	public $action_auth = 'justwpforms_zapier_auth';
	public $action_subscribe = 'justwpforms_zapier_subscribe';
	public $action_unsubscribe = 'justwpforms_zapier_unsubscribe';
	public $action_samples = 'justwpforms_zapier_samples';
	public $action_output_fields = 'justwpforms_zapier_output_fields';
	public $action_forms = 'justwpforms_zapier_forms';
	public $action_activity = 'justwpforms_zapier_activity';
	...
	public function __construct() {
		$this->service = justwpforms_get_integrations()->get_service( 'zapier' );
	}

	public function hook() {
		require_once( justwpforms_get_integrations_folder() . '/services/zapier/helper-zapier.php' );

		add_action( 'parse_request', array( $this, 'parse_request' ) );
		add_action( 'justwpforms_pending_submission_success', array( $this, 'submission_success' ), 10 );
		add_filter( 'justwpforms_zapier_part_visible', array( $this, 'part_is_visible' ), 10, 2 );
		add_filter( 'justwpforms_zapier_part_value', array( $this, 'part_value' ), 10, 2 );
	}
...
if ( ! function_exists( 'justwpforms_get_integration_zapier' ) ):

function justwpforms_get_integration_zapier() {
	$instance = justwpforms_Integration_Zapier::instance();
	$instance->hook();
...
justwpforms_get_integration_zapier();
