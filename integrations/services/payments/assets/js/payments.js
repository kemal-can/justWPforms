( function( $, data ) {
	...
	justwpforms.parts.payments = {
		...
		onPaymentMethodChange: function( e ) {
			...
			$( '.justwpforms-part-error-notice__realtime', this.$el ).hide();
		},
		...
		updateServices: function() {
			$( '.justwpforms-payments-service', this.$el ).removeClass( 'show' );
			$( '.justwpforms-payments-service--' + this.paymentMethod, this.$el ).addClass( 'show' );
		}
	};

} )( jQuery, _justwpformsSettings.payments );
