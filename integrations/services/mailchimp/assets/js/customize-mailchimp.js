( function( $, _, Backbone, api, mailchimpData, settings ) {
	...
	justwpforms.classes.views.FormEmail = FormEmail.extend( {
		...
		ready: function() {
			...
			this.mailchimpGroupsTemplate = '#justwpforms-customize-mailchimp-groups-template';
...
} ) ( jQuery, _, Backbone, wp.customize, _justwpformsMailchimpData, _justwpformsSettings );
